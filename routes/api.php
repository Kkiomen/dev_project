...
$v1Routes = function () {
    ...
    Route::prefix('brands/{brand}/sm-content-plans')->group(function () {
        ...
        Route::get('{smContentPlan}/generate-status', [SmContentPlanController::class, 'generateStatus']);
        ...
        Route::post('{smContentPlan}/slots/bulk-delete', [SmContentPlanController::class, 'bulkRemoveSlots']);
        ...
        Route::post('{smContentPlan}/generate-topic-proposition', [SmContentPlanController::class, 'generateTopicProposition']);
    ...
    Route::get('video-projects/{publicId}/media/{filename}', [VideoProjectController::class, 'serveMedia']);
};
