...
export const postFields: INodeProperties[] = [
	...
	},
	{
		...
		typeOptions: { rows: 5 },
		default: '',
		description: 'Main post content/caption',
		displayOptions: { show: { resource: ['post'], operation: ['create'] } },
	},
	{
	...
	{
		displayName: 'AI Generation Options',
		name: 'aiOptions',
		type: 'collection',
		...
		options: [
			{
				...
				typeOptions: { rows: 3 },
				default: '',
				description: 'Prompt/description for AI text generation (used by automation)',
			},
			{
				...
				typeOptions: { rows: 3 },
				default: '',
				description: 'Prompt/description for AI image generation (used by automation)',
			},
			{
				displayName: 'Tone',
				name: 'tone',
