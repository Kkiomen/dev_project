        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    :class="{
                        'border-gray-300 focus:border-blue-500 focus:ring-blue-500': !isDescriptionStarted || isDescriptionValid,
                        'border-amber-300 focus:border-amber-500 focus:ring-amber-500': isDescriptionStarted && !isDescriptionValid,
                    }"
                />
