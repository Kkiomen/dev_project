...
const navLinks = computed(() => [
    ...
    {
        to: '/app/manager',
        label: t('navigation.aiManager'),
        icon: 'ai-manager',
        isActive: route.path.startsWith('/app/manager'),
    },
]);
    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-3 space-y-1">
            ...
            >
                ...
                <!-- AI Manager -->
                <svg v-else-if="link.icon === 'ai-manager'" class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                ...
                <template v-if="authStore.isAdmin">
                    <div class="pt-2 mt-2 border-t border-gray-100">
                        ...
                        >
                            ...
                            <span class="truncate">{{ t('navigation.adminSettings') }}</span>
                        </RouterLink>
                    </div>
                </template>
            </div>
